...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "net.firedroid.build_type";
    private static final String OTA_APP_PACKAGE = "net.firedroid.ota";
    ...
    public int getAvailabilityStatus() {
        ...
        if (!mUm.isAdminUser() || (!buildtype.equalsIgnoreCase("ci"))){
